...
```{r setup, include=FALSE}
getwd()
df <- read.csv('../r_bootcamp/2020_Results.csv', header =TRUE, sep=";")
df <- data.frame(df)
```
...
###Data Visualisation: All athletes
```{r setup, include=FALSE}
...
#upper 25% of Nations with participations
...
###How does the age structure looks?
...
### Athletes with more than 6 starts, what is the highest rank reached?
